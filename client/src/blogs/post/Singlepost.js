...
const Singlepost = () => {
  // const PF = "http://localhost:8400/images/";
  const PF = "/images/";
  ...
  return (
    ...
    <div>
      ...
      <div className="bg-green-500 mt-4 mx-auto rounded-md text-center relative pt-10 md:h-4/6 w-5/6">
        <img
          src={PF + userpost.photo}
        ...
        <img src={PF + userpost.photo} className="rounded-md pt-3 mx-auto" />
      </div>
